...
instantiated by this project's PyQt5 GUI. Superseded by segment_fov /
segment_fov_classical in codelab_pipeline/segmentation/segment.py, which
ui/cell_segment_panel.py drives instead. Moved here verbatim (unmodified)
on 2026-08-07.
"""
import os
import time
...
from codelab_pipeline.segmentation.segment import get_model_cyto
