...
instantiated by this project's PyQt5 GUI. Superseded by compute_cell_alignment
in codelab_pipeline/alignment/chain.py, which ui/alignment_panel.py drives
instead. Moved here verbatim (unmodified) on 2026-08-07.
"""
import os
import time
...
from codelab_pipeline.alignment.chain import align_cell
